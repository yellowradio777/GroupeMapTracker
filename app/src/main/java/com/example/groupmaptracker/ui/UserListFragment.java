...
import com.example.groupmaptracker.models.PolylineData;
...
import com.example.groupmaptracker.util.ViewWeightAnimationWrapper;
    ...
    private void addPolylinesToMap(final DirectionsResult result) {
        new Handler(Looper.getMainLooper()).post(new Runnable() {
            ...
            public void run() {
                ...
                // Check if polylines array have args
                ...
                for (DirectionsRoute route : result.routes) {
                    ...
                    // Shortest path highlight and camera adjust
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            for (int i = 0; i < mClusterMarkers.size(); i++) {
                                try {
                                    if (mClusterMarkers.get(i).getUser().getUser_id().equals(updatedUserLocation != null ? updatedUserLocation.getUser().getUser_id() : null)) {
